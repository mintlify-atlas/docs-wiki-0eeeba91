...
- The same string-based `(EntityType, EntityId)` is used by [Comments](/modules/cms-kit/comments) and by the reactions/marked-items capabilities described in the [Domain layer](/modules/cms-kit/domain#reactions--emoji-style-user-reactions) walk-through.
