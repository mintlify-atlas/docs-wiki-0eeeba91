...
`MaxNameLength` (128), `MaxProviderNameLength` (64), `MaxProviderKeyLength` (64), `MaxDisplayNameLength` (128), `MaxProvidersLength` (128), `MaxStateCheckersLength` (1024) are all in `PermissionGrantConsts`, `PermissionDefinitionRecordConsts`, `PermissionGroupDefinitionRecordConsts` (in `Domain.Shared`).
</Accordion>
