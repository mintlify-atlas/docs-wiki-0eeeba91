...
<CardGroup cols={2}>
  ...
  <Card title="Http" icon="globe" href="/http/http-module">
    `AbpHttpModule`, `ApplicationApiDescriptionModel`, `HttpMethodHelper`, `AbpHttpConsts`, `ParameterBindingSources`, jQuery ProxyScripting generators.
  </Card>
  ...
  <Card title="RemoteServices" icon="diagram-project" href="/http/remote-services">
    `AbpRemoteServicesModule`, `AbpRemoteServiceOptions`, `RemoteServiceConfiguration`, `RemoteServiceConfigurationDictionary`, `IRemoteServiceConfigurationProvider`.
  </Card>
