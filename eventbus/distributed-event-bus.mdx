...
description: "Inside DistributedEventBusBase: outbox enqueue, inbox dedup, OutboxSenderManager and InboxProcessManager workers, DistributedEventOptions wiring."
---
