...
<AccordionGroup>
  ...
  <Accordion title="What about schema evolution?">
    Add optional fields freely — old consumers ignore unknown properties. For breaking changes, mint a new `[EventName("…​.v2")]` and run both versions side-by-side during rollout. See [Abstractions → Evolving event schemas](/eventbus/abstractions#evolving-event-schemas).
  </Accordion>
</AccordionGroup>
