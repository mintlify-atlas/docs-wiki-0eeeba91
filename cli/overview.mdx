...
That keeps the surface easy: to add a command you implement `IConsoleCommand` and register it in [`AbpCliCoreModule.ConfigureServices`](/cli/architecture#abpclicoremodule). The selector picks it up by string key.
