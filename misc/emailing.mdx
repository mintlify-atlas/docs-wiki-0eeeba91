...
There is also `EmailingTemplateConstants` (used by other modules to publish their template names against this section's machinery). Keep names there to avoid magic strings spreading.
